...
namespace Yuu
{
    public class ProcedurePreload : ProcedureBase
    {
        ...
        protected override void OnUpdate(ProcedureOwner procedureOwner, float elapseSeconds, float realElapseSeconds)
        {
            ...
            Debug.Log(GameEntry.Config.HasConfig("Scene.GameScene"));
            SetComponents();
            
            procedureOwner.SetData<VarInt32>(Constant.ProcedureData.NextSceneId, GameEntry.Config.GetInt("Scene.GameScene"));
